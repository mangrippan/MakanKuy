...
<?php $query=$this->db->select('*')->from('rekomendasi')->where('status',0)->get();$rekomendasi=$query->num_rows();?>
<div class="wrapper wrapper-content">    
 <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-primary pull-right">Rekomendasi</span>
                                <h5>Rekomendasi</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $rekomendasi;?></h1>
                                <small>Rekomendasi restoran</small>
                            </div>
                        </div>
                    </div>
