...
<br>
    ...
    <tbody>
			...
			<tr class="odd gradeX">
				...
				<td>
					<a href="<?php echo site_url();?>Admin/updateSaldo/<?php echo $new->id_konsumen."/".$new->jumlah_topup."/".$new->status;?>" class="btn btn-primary" name="proses">Proses</a>
					<a href="<?php echo site_url();?>Admin/hapusTopup/" class="btn btn-danger" name="hapus"> Hapus</i></a>
				</td>
