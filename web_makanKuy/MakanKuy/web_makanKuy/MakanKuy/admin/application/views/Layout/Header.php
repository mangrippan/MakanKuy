...
<?php $query=$this->db->select('*')->from('rekomendasi')->where('status',0)->get();$rekomendasi=$query->num_rows();//selesai?>

<?php $totalLaporan= $topup+$resto_baru+$rekomendasi;?>
    <div id="wrapper">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo site_url();?>Admin/dataResto">Data Restoran </a></li>
                        <li><a href="<?php echo site_url();?>Admin/verifikasiResto">Verifikasi Restoran<?php if ($resto_baru>0){?> <span class="label label-danger pull-right"><?php echo $resto_baru;?></span> <?php } ?></a></li>
                    </ul>
                </li>
				<li>
